...
| **MVT tile endpoint** — `GET /tiles/taxis/timeline/{z}/{x}/{y}.pbf?snapshots=&zone=` | `design-doc.md` §4.7.2 (defines) | `MVP` §7.1 (references) | `api-contract.md` §Batched Timeline Tile Endpoint (documents); frontend calls gov-data directly for tiles |
...
| **Query types** — QT-01 through QT-09 | `design-doc.md` §4.1–4.9 (one endpoint per type) | `MVP` §3 (defines type table), §6.3 (STEP ORDER routing) | `api-contract.md` (if new `data.type`/`context.type`), `design.md` (if new viz mode) |
...
- [ ] gov-data `docs/design-doc.md` §4.0 — update union table and add endpoint section
...
- [ ] gov-data `docs/design-doc.md` §4.x — update endpoint path, params, and summary table (§4.10)
...
- [ ] gov-data `docs/design-doc.md` §4.x — update param table
...
- [ ] gov-data `docs/design-doc.md` §4.0 — update context type table + add endpoint
...
- [ ] gov-data `docs/design-doc.md` §4.0 — update envelope definition
...
- [ ] gov-data `docs/design-doc.md` — add endpoint section (4.x) + update summary table (4.10)
...
- [ ] gov-data `docs/design-doc.md` §8 — update error table
...
- [ ] gov-data `docs/design-doc.md` — update relevant endpoint response examples
...
| **civic-app query types** | gov-data `docs/design-doc.md` (endpoints), civic-frontend `apis-data-contract.md` |
| **civic-frontend API contract** | civic-app `MVP-taxi-spatial-qa.md` §8 (must match), gov-data `docs/design-doc.md` (upstream source) |
